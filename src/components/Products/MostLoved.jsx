...
export default function MostLoved() {
  ...
  const displayedProducts = isMobile ? mostLovedProducts.slice(0, 4) : mostLovedProducts;
    ...
    <section className="py-16 md:py-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-gray-600 text-base md:text-lg leading-relaxed mb-8 max-w-2xl mx-auto">
              Explore our most cherished handcrafted pieces, loved by customers for their beauty, quality, and timeless appeal
            </p>
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className={`grid gap-4 md:gap-8 max-w-7xl mx-auto ${
            isMobile 
              ? 'grid-cols-2 gap-4' 
              ...
              <Link to={`/product/${product.id}`} className="block">
                ...
                <div className={`${isMobile ? 'p-5' : 'p-6'}`}>
                  ...
                  <h3 className={`font-bold text-gray-900 group-hover:text-orange-600 transition-colors line-clamp-2 ${
                    isMobile ? 'text-base mb-4 leading-tight' : 'text-lg mb-3'
                  }`}>
                    {product.name}
                  </h3>
        ...
        {isMobile && mostLovedProducts.length > 4 && (
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            <div className="max-w-md mx-auto">
              <p className="text-gray-600 text-sm mb-6">
                Explore more beloved products in our collection
              </p>
              <Link 
                to="/shop" 
