        ...
        >
          {products.map((product) => (
            <motion.div
              ...
              className="group"
            >
              <div className="relative overflow-hidden rounded-lg bg-gray-100 object-cover">
                <img
                  src={product.image}
                  alt={product.name}
                  className="w-full h-74 object-cover transition-transform duration-300 group-hover:scale-110"
                />
